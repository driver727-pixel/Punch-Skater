...
Use **Public / Internal / Reveal** tags whenever a district note includes writer-only truth or a
future-facing contradiction.
...
**Public:** The Roads are where route events, ambushes, weather disasters, and long-haul courier
drama erupt between destinations.

**Internal:** They are a corridor gameplay layer rather than a normal mission hub or civic district.
For list hygiene, it is still acceptable to treat them as district-equivalent.

**Reveal:** If the story ever needs to call attention to the mismatch between map grammar and world
logic, do it as a reveal rather than baseline reference text.
...
**Public:** An off-grid settlement built from carved trunks, rope bridges, and hard-earned suspicion.
The Wooders trust wooden decks, manual craft, and very little else.
...
**Public:** The City's empty spectacle district. Everything glows, everything records, and almost
nobody is physically present. Human couriers only work here when the autonomous network is not
allowed to touch the package.
...
**Internal:** Electropolis is still part of the canon, but the public Codex intentionally withholds
it from the main district grid.

**Reveal:** It exists as a clean-looking security showcase where the Fuzz tolerates skaters only
